...
public class BootstrapKMeansWithTruth {
    ...
    public BootstrapKMeansWithTruth(
            double[] sample,
            int k,
            int nitter, 
            double limit, 
        ...
        variance = SamplingUtilities.VectorVariance(sampleCenters, truth);
        totalIterations += sampleCenters.length;
    ...
    public BootstrapKMeansWithTruth(
            ...
            double[] truth,
            int bootstraps) {
        this(sample, k, nitter, limit, truth, bootstraps, sample.length);
    }
