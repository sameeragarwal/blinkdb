...
#set output "session_time_histogram_top_50.pdf"
#set xlabel "Sample Size (rows X 1000)"
#set ylabel "Statistical Answer \n(with error bars)"
set output "session_time_histogram_top_50.pdf"
set xlabel "Percentage of Unique Keys (Sorted)"
set ylabel "Frequency"
set title "Histogram of session_time"
...
plot "session_time_histogram_top_50.txt" using 1:2 with lines notitle ls 1
#     "error_bars.txt" using 1:2 notitle ls 1, \
#     "error_bars.txt" using 1:2:4:3 with yerrorbars notitle ls 5, \
#     2.0 notitle lt 3 lw 0.5
