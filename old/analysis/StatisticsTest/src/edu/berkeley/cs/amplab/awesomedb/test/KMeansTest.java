...
import edu.berkeley.cs.amplab.awesomedb.BlbKMeans;
import edu.berkeley.cs.amplab.awesomedb.BootstrapKMeans;
...
public class KMeansTest {
    ...
    private static void bootstrapExperiment(double[] sample,
        ...
        BootstrapKMeans bootstrap = new BootstrapKMeans(sample,k, nitter, delta, numberOfBootstraps);
    ...
    private static void blbExperiment(double[] sample, 
            ...
            Mean perbagTime,
            Mean blbTotalTime) {
        BlbKMeans blb = new BlbKMeans(sample, k, nitter, delta, bagExp, numberOfBags, numberOfBootstraps);
