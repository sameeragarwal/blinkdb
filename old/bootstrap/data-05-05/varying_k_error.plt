...
set output "varying_k_error_Non-Zero Min.pdf"
set xlabel "Sample Size (MB)"
set ylabel "Relative Error"
set title "Non-Zero Min"
...
plot "Non-Zero Minvarying_k.txt" using 1:2 with lines title "K = 100" ls 1, \
     "Non-Zero Minvarying_k.txt" using 1:3 with lines title "K = 200" ls 2, \
     "Non-Zero Minvarying_k.txt" using 1:4 with lines title "K = 300" ls 3

#plot "Non-Zero Minvarying_k.txt" using 1:2 with lines title "K = 100" ls 1, \
#     "Non-Zero Minvarying_k.txt" using 1:2 notitle ls 5, \
#     "Non-Zero Minvarying_k.txt" using 1:3 with lines title "K = 200" ls 2, \
#     "Non-Zero Minvarying_k.txt" using 1:3 notitle ls 6, \
#     "Non-Zero Minvarying_k.txt" using 1:4 with lines title "K = 300" ls 3
#     "Non-Zero Minvarying_k.txt" using 1:4 notitle ls 7
