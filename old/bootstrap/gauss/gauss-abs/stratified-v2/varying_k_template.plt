...
plot "_gnuplot_file_" using 1:3 with lines title "K = 100" ls 1, \
     "_gnuplot_file_" using 1:4 with lines title "K = 200" ls 2, \
     "_gnuplot_file_" using 1:5 with lines title "K = 300" ls 3

#plot "_gnuplot_file_" using 1:2 with lines title "K = 100" ls 1, \
#     "_gnuplot_file_" using 1:2 notitle ls 5, \
#     "_gnuplot_file_" using 1:3 with lines title "K = 200" ls 2, \
#     "_gnuplot_file_" using 1:3 notitle ls 6, \
#     "_gnuplot_file_" using 1:4 with lines title "K = 300" ls 3, \
