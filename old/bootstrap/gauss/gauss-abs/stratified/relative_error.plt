...
set output "relative_error_Mean.pdf"
...
plot "Meanrelative_error.txt" using 1:2 with lines title "Bootstrap" ls 1

#plot "Meanrelative_error.txt" using 1:2 with lines title "Bootstrap" ls 1, \
#     "Meanrelative_error.txt" using 1:3 with lines title "Sampling Truth (K=300)" ls 2, \
#     "Meanrelative_error.txt" using 1:4 with lines title "Ground Truth" ls 3

#plot "Meanrelative_error.txt" using 1:2 with lines title "Bootstrap" ls 1, \
#     "Meanrelative_error.txt" using 1:2 notitle ls 5, \
#     "Meanrelative_error.txt" using 1:3 with lines title "Sampling Truth (K=300)" ls 2, \
#     "Meanrelative_error.txt" using 1:3 notitle ls 6, \
#     "Meanrelative_error.txt" using 1:4 with lines title "Ground Truth" ls 3, \
#     "Meanrelative_error.txt" using 1:4 notitle ls 7
