...
set output "RCFile-BlinkDB-Over-Hadoop.pdf"
set xlabel "Sample Size (MB)"
set ylabel "Response Time (seconds)"
set title "BlinkDB Over Hadoop"
...
plot "rcfile-disk.txt" using 1:2 with lines title "Sequence Files" ls 1, \
     "rcfile-disk.txt" using 1:3 with lines title "RCFile (Uncompressed)" ls 2, \
     "rcfile-disk.txt" using 1:4 with lines title "RCFile (default Compression)" ls 3, \
     "rcfile-disk.txt" using 1:2 notitle ls 5, \
     "rcfile-disk.txt" using 1:3 notitle ls 6, \
     "rcfile-disk.txt" using 1:4 notitle ls 7
