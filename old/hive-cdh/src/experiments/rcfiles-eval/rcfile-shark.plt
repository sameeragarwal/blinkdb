...
set output "RCFile-BlinkDB-Over-Shark.pdf"
...
plot "rcfile-memory.txt" using 1:2 with lines title "Sequence Files" ls 1, \
     "rcfile-memory.txt" using 1:3 with lines title "RCFile (Uncompressed)" ls 2, \
     "rcfile-memory.txt" using 1:4 with lines title "RCFile (Default Compression)" ls 3, \
     "rcfile-memory.txt" using 1:2 notitle ls 5, \
     "rcfile-memory.txt" using 1:3 notitle ls 6, \
     "rcfile-memory.txt" using 1:4 notitle ls 7
